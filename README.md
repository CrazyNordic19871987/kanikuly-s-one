...
Веб-приложение для управления летними каникулами — образовательная игра-стратегия с погружением в профессии для детей 7–12 лет.
...
| 🏕️ **О каникулах** | Концепция, клубы, команда, инфраструктура |
